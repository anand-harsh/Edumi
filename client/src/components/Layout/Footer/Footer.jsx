...
const Footer = () => {
  return (
    <Box paddingLeft={'6vw'} paddingTop={'10'} paddingBottom={'5'} paddingRight={"6vw"} bg={'#0d0b1e'}>
      <HStack style={{ overflowY: "hidden" }} justifyContent={"space-between"}>
        <Box><Heading children="Let's Start with Edumi!" color={'yellow.400'} style={{ overflowY: "hidden" }} fontSize={"2rem"} /></Box>
        <a href="mailto:harsh.anand.ggl@gmail.com">
          <Box bg={'#db3e00'} padding={'1'} borderRadius={'5px'} marginRight={"3vw"} >
            <Heading
              fontFamily={'body'}
...
<Box flexWrap={"wrap"}>
      ...
      <HStack marginLeft={"1vw"} marginTop={"30px"} style={{ overflowY: "hidden" }}>
